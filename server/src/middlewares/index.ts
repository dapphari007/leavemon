...
import { allRolesAuth, superAdminAuth, managerHrAuth, managerAuth, hrAuth, teamLeadAuth, clientAuth } from './authMiddleware';
...
export const registerMiddlewares = (server: Server): void => {
  ...
  server.auth.strategy('client', 'jwt', clientAuth.options);
